...
//            this.mass = Math.PI * radius * radius;
    ...
    private final int N = 8, STEPS = 150;
    private final double dt = 0.4, drag = 1.0;
    private final double A = 400, B = 6000;
    private final double BOX_WIDTH = 1600, BOX_HEIGHT = 1600;
    private final double AREA_WIDTH = 800, AREA_HEIGHT = 800;
    private final double MIN_RADIUS = 1, MAX_RADIUS = 2;
    ...
    private void logResults() {
    	...
    	try {
            writer = new PrintWriter("src/Floor/log_unit3.txt");
