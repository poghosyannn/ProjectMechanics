...
public class OptimalFloorSimulator implements Drawable {
    ...
    private final double A = 40;
    private final double B = 40000;
    private final double AIR_RESISTANCE = 1.0;
    ...
    private final double MAX_RADIUS = 3;
    ...
    public void simulate() {
        ...
        try {
            PrintWriter pw = new PrintWriter("src/OptFloor/log3.txt");
    ...
    private void applyPairwiseForce(Circle c1, Circle c2) {
        ...
        double forceMag = A / distSq - B / (distSq * distSq);
    ...
    private double calculatePotentialEnergy() {
        ...
        for (int i = 0; i < NUM_CIRCLES; i++) {
            ...
            for (int j = i + 1; j < NUM_CIRCLES; j++) {
                ...
                double energy = -A / dist + B / (dist * dist);
                totalEnergy += energy;
            }
        }
